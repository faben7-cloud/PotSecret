...
export default function NotFoundPage() {
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-2xl items-center py-12">
      <div className="w-full rounded-[2rem] border border-white/60 bg-white/95 p-8 text-center shadow-card">
        <p className="text-sm font-medium normal-case tracking-[0.16em] text-coral">404</p>
        <h1 className="mt-3 text-3xl font-semibold text-ink">{copy.errors.notFoundTitle}</h1>
        <p className="mt-3 text-sm leading-6 text-ink/70">{copy.errors.notFoundBody}</p>
